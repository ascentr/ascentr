...
function randomMaths() {
  ...
  let x = document.querySelectorAll("#display button")
  var xLen = x.length
  if (xLen < 5) {
    document.getElementById("message").innerHTML = "Please choose 6 numbers"
    return
  }
  else {
  ...
  for (i = 0; i < 5; i++) {
    ...
    document.getElementById("result").innerHTML = `Target : ${result}`
    timer()
