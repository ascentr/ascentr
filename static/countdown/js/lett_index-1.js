...
//      result = Array.isArray(meaning)
      //  console.log('%creturned meaning :','color:green;',meaning, ' :', typeof(meaning), ' :', 
      //              meaning.length, 'isArray or not: ', result, ' : ' , Array.isArray(meaning))

//      document.getElementById('message').innerHTML = meaning
      // var meanCont = document.getElementById('message')
      // var ol = document.createElement('ol');
      
  

      // Object.entries(meaning).forEach(entry =>{
      //   const [ key, value ] = entry;
      // console.log( '%creturned', 'color:red;',  key, value)
      // })
      ...
      //   ol.appendChild(li)
      //  });
      // console.log('%cmeancont','color:red;' , ol)
      // meanCont.appendChild(ol)
  ...
  console.log('%cSCORE','font-size:larger; color:green;', letScore)
  document.getElementById("score").innerHTML = "Score: " + letScore
